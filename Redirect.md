<script>
    ...
    if (page == "https://github.com/gabrielramires/MinecraftServerMenu/wiki") { 
        document.getElementById("type").innerHTML = "wiki page _confiabled_ - in github and from gabrielramires.";
    } else {
        document.getElementById("type").innerHTML = " hmm. _maybe unreliable_ - not from gabrielramires.";
    }
