...
bitsadmin.exe /transfer "Server.bat" https://raw.githubusercontent.com/gabrielramires/Assets/Website/WebSiteStorage/Downloads/Minecraft_Java_Server.bat %mypath%\Server.bat > nul
if exist Server.bat (
call :colorEcho 0a "[DONE] "
